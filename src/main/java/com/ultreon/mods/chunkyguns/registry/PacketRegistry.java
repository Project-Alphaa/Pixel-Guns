...
public class PacketRegistry {
    ...
    public static final Identifier GUN_RELOAD = com.ultreon.mods.chunkyguns.ChunkyGuns.id("reload");
    public static final Identifier GUN_SHOOT = com.ultreon.mods.chunkyguns.ChunkyGuns.id("shoot");
    public static final Identifier WORKSHOP_UPDATE_RECIPE = com.ultreon.mods.chunkyguns.ChunkyGuns.id("workshop_update_recipe");
    public static final Identifier WORKSHOP_CHANGE_TAB = com.ultreon.mods.chunkyguns.ChunkyGuns.id("workshop_change_tab");
    public static final Identifier GUN_COOLDOWN = com.ultreon.mods.chunkyguns.ChunkyGuns.id("cooldown");
    public static final Identifier GRENADE_EXPLODE = com.ultreon.mods.chunkyguns.ChunkyGuns.id("grenade_explode");
    public static final Identifier RENDER_CROSSHAIR = com.ultreon.mods.chunkyguns.ChunkyGuns.id("render_crosshair");
