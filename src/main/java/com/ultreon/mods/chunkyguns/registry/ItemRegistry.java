...
import com.ultreon.mods.chunkyguns.item.*;
...
import com.ultreon.mods.chunkyguns.item.gun.variant.*;
...
public class ItemRegistry {
    ...
    private static Item register(String name, Item item) {
        return ItemRegistry.register(com.ultreon.mods.chunkyguns.ChunkyGuns.id(name), item);
    }
