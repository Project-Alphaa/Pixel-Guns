...
import com.ultreon.mods.chunkyguns.entity.projectile.thrown.*;
import com.ultreon.mods.chunkyguns.entity.projectile.*;
...
public class EntityRegistry {
    ...
    private static <T extends Entity> EntityType<T> register(String name, FabricEntityTypeBuilder<T> type) {
        return Registry.register(Registries.ENTITY_TYPE, com.ultreon.mods.chunkyguns.ChunkyGuns.id(name), type.build());
    }
}